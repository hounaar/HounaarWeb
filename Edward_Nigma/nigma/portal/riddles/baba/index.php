...
<div class="container mt-5" id="riddle-page">
    ...
    <h3>I LOST MY WIFE. THEN MY GIFT FROM MY WIFE AFTER 2 DAYS 
        NOW EVERY ONE IS PAYING THE PRICES.
        WHO AM I?
    </h3>
</div>
    </div>
...
<script type="text/javascript" src="/src/js/answers/baba.js"></script>
