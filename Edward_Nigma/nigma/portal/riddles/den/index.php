...
<div class="container mt-5" id="riddle-page">
    ...
    <h3>I WAS THE DA CANDIDATE, WORKED ALOT WITH COMMISSIONER TO CLEAN 
        OUT THE CITY FROM CRIMINALS BUT THEY GAVE A CALL SIGN.
        WHO AM I?        
</h3>
</div>
    </div>
...
<script type="text/javascript" src="/src/js/answers/den.js"></script>
